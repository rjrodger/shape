...
Both behaviours follow directly from the decision above; neither is a bug in the
...
divergence of this size would hollow it out. The known divergences we do accept
