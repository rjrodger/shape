...
Decisions about Shape's design that are expensive to revisit, with the reasoning
...
| # | Decision | Status |
| - | -------- | ------ |
| [0001](0001-validation-is-synchronous.md) | Validation is synchronous, in both languages | Accepted |
